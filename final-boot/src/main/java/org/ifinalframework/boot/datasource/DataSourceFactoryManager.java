...
public final class DataSourceFactoryManager {
    ...
    private final Map<String, DataSourceFactory<? extends DataSource>> cache =
            new LinkedHashMap<>();
    ...
    public <T extends DataSource> DataSourceFactory<T> getDataSourceFactory(Class<T> clazz) {
        return (DataSourceFactory<T>) cache.get(clazz.getName());
    }
